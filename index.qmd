...
Table 3 presents the top features ranked by their importance in the Random Forest model, measured using the MeanDecreaseGini criterion. These variables contributed the most to the model’s ability to distinguish between fraudulent and legitimate transactions, providing insight into which aspects of the data the model relied on most during prediction.  
...
| PC1            |  7.466844  | 12.282018  | 12.781813              | 2427.450         |
    ...
    Table 3. Feature importance table by MeanDecreaseGini
