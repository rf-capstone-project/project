...
While RF is widely regarded as an accurate and robust method, it does not lack vulnerabilities, one of the main being the method’s sensitivity towards class imbalance. To address some of these shortcomings, @Valavi2021, @Yu20215, & @Ghaleb2023 proposed the following strategies to address the problems of class imbalance:
